...
const OtherStaffTab = () => {
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://susu-pro-backend.onrender.com/staff/${selectedStaff.id}`, {
        method: 'PUT',
        headers: {
  ...
  const handlePermissionsSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://susu-pro-backend.onrender.com/staff/${selectedStaff.id}/permissions`, {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
        },
