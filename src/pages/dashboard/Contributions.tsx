        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
          ...
          <div>
            ...
            >
              ...
              {staffList.filter(staff => staff.role?.toLocaleLowerCase() === 'teller' || staff.role?.toLocaleLowerCase() === 'mobile_banker' || staff.role?.toLocaleLowerCase() === 'mobile banker' || staff.role?.toLocaleLowerCase() === 'accountant').map(staff => (
