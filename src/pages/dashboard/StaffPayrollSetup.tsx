...
const StaffPayrollSetup = ({ companyId, staffId }) => {
  ...
  const fetchStaffData = async () => {
    try {
      const [profileRes, allowancesRes, deductionsRes] = await Promise.all([
        fetch(`https://susu-pro-backend.onrender.com/payroll/${companyId}/staff/${staffId}/salary-profile`),
        fetch(`https://susu-pro-backend.onrender.com/payroll/${companyId}/staff/${staffId}/allowances`),
        fetch(`https://susu-pro-backend.onrender.com/payroll/${companyId}/staff/${staffId}/deductions`)
      ]);
  ...
  const fetchPayrollTypes = async () => {
    const res = await fetch(`https://susu-pro-backend.onrender.com/payroll/${companyId}/types`);
  ...
  const AllowanceModal = () => {
    ...
    const handleSubmit = async () => {
      const res = await fetch(`https://susu-pro-backend.onrender.com/payroll/${companyId}/staff/${staffId}/allowances`, {
        method: 'POST',
