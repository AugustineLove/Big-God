...
export const SettingsProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  const changePassword = async (
    ...
    try {
      const res = await fetch(
        "http://localhost:5050/api/staff/change-password",
        {
          method: "PUT",
          headers: {
  ...
  const updateStaffDetails = async (
    ...
    try {
      const res = await fetch(
        `http://localhost:5050/api/staff/${staffId}?company_id=${companyId}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  try {
    const res = await fetch(
      `http://localhost:5050/api/staff/${staff_id}/reset-password`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
  ...
  try {
    const res = await fetch(
      `http://localhost:5050/api/staff/${staff_id}/force-reset-password`,
      {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
